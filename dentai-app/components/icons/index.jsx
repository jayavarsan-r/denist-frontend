...
export default function Icon({ name, size = 24, stroke = 2, color = 'currentColor', fill = 'none', style }) {
  ...
  const paths = {
    ...
    tooth: <path d="M8.25 3c-2.5 0-4 2-4 5 0 2 .8 3 1.2 5.5C5.85 16 6.25 21 8.25 21c1.6 0 1.5-4 2.5-5.5.6-.9 1.4-.9 2 0C14.25 17 14.15 21 15.75 21c2 0 2.4-5 2.8-7.5C18.95 11 19.75 10 19.75 8c0-3-1.5-5-4-5-1.6 0-2.4.8-3.5.8S9.85 3 8.25 3Z" {...p}/>,
